  ...
  return (
    <Row className="align-items-center">
      <Col xl={12} lg={12} md={12} xs={12}>
        {/* Bg */}
        <div className="pt-20 rounded-top" style={{ background: 'url(/images/background/background-3.jpg) no-repeat', backgroundSize: 'cover' }}>
        </div>
          ...
          <div className="d-flex align-items-center justify-content-between pt-4 pb-6 px-4">
            <div className="d-flex align-items-center">
              ...
              <div className="avatar-xxl avatar-indicators avatar-online me-2 position-relative d-flex justify-content-end align-items-end mt-n10">
                <Image src="/images/avatar/avatar-4.jpg" className="avatar-xxl rounded-circle border border-4 border-white-color-40" alt="" />
              ...
              {/* text */}
              <div className="lh-1">
                <h2 className="mb-0">Shweta Katore
                  <Link href="#!" className="text-decoration-none" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Beginner">
                  </Link>
                </h2>
                <p className="mb-0 d-block"><i class="fas fa-code"></i> Frontend Developer &nbsp;&nbsp; <i class="fas fa-map-marker-alt"></i> Pune &nbsp;&nbsp;  <i class="far fa-calendar-alt"></i> 01/09/2023</p>
              </div>
            </div>
            <div>
              <Link href="/settings" className="btn btn-outline-primary d-none d-md-block">Edit Profile</Link>
            </div>
          </div>
          {/* nav */}
