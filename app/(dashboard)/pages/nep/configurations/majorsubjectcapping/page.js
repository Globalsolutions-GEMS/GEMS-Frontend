...
const MajorSubjectCapping = () => {
  const hasMounted = useMounted();

  return (
    <Container fluid className="p-6">
      {/* Page Heading */}
      <PageHeading heading="Major Subject Capping" />
      <Breadcrumb>
        <Breadcrumb.Item href="#">NEP</Breadcrumb.Item>
        <Breadcrumb.Item href="#">Configurations</Breadcrumb.Item>
        <Breadcrumb.Item active>Major Subject Capping</Breadcrumb.Item>
      </Breadcrumb>
...
export default MajorSubjectCapping;
