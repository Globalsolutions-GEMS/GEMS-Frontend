...
const SubjectCategoryPreference = () => {
  const hasMounted = useMounted();

  return (
    <Container fluid className="p-6">
      {/* Page Heading */}
      <PageHeading heading="Subject Category Preference" />
      <Breadcrumb>
        <Breadcrumb.Item href="#">NEP</Breadcrumb.Item>
        <Breadcrumb.Item href="#">Configurations</Breadcrumb.Item>
        <Breadcrumb.Item active>Subject Category Preference</Breadcrumb.Item>
      </Breadcrumb>
...
export default SubjectCategoryPreference;
