                ...
                {hasMounted && (
                  <Form>
                    ...
                    <Row className="mb-3">
                      ...
                      <Col sm={10} className="mb-3 mb-lg-0 d-flex align-items-center">
                        <Form.Check
                          inline
                          label="Daily"
                          name="group1"
                        ...
                        <Form.Check
                          inline
                          label="Subject Wise Defaulter List"
                          name="group1"
                          type="radio"
                          id="ch1"
                        />
