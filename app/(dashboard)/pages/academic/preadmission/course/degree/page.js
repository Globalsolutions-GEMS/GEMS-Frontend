                                    ...
                                    <Form>
                                        ...
                                        <Row className="mb-3">
                                            ...
                                            <Col sm={9} className="mb-3 mb-lg-0">
                                                <Form.Control type="text" placeholder="Please Enter Degree/Diploma Short Name" id="degreediploma" required />
                                            </Col>
                                        </Row>
                                        <Row className="mb-3">
                                            ...
                                            <Col sm={9} className="mb-3 mb-lg-0">
                                                <Form.Control type="text" placeholder="Please Enter Degree/Diploma Full Name" id="degrediplomaname" required />
                                            </Col>
                                        </Row>
                                        <Row className='mb-3'>
