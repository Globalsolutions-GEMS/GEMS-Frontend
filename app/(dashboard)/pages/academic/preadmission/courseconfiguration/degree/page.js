    ...
    <Container fluid className="p-6">
                  ...
                  <Form onSubmit={handleSubmit}>
                    <Row className="mb-3">
                      <Form.Label
                        ...
                        htmlFor="fullName"
                      >
                        Degree/Diploma<span className="text-danger">*</span>
                      </Form.Label>
                    ...
                    <Row className="mb-3">
                      ...
                      <Col sm={9} className="mb-3 mb-lg-0">
                        <Form.Control
                          ...
                          id="degreeDiplomaName"
                          value={formData.degreeDiplomaName}
                          onChange={handleInputChange}
                          required
                        />
                      </Col>
      ...
      <>
        ...
        <Pagination className="justify-content-end">
          ...
          />
          {[...Array(Math.ceil(degreeData.length / itemsPerPage))].map(
            (_, index) => (
              <Pagination.Item
                key={index}
          ...
          <Pagination.Next
            onClick={() => paginate(currentPage + 1)}
            disabled={
              currentPage === Math.ceil(degreeData.length / itemsPerPage)
            }
          />
        </Pagination>
      </>
