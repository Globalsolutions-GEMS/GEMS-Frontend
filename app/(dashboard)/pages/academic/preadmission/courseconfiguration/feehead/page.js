...
const FeeHead = () => {
  ...
  const hasExcessFee = () => {
    ...
    const existingFeeheadWithExcessFee = feeheadData.find((feehead) => {
      return (
        feehead.cashbook &&
        feehead.cashbook.id === parseInt(selectedCashbook) &&
        feehead.excessFee
      );
    });
                      ...
                      <Col>
                        ...
                        <Row className="mb-3">
                          ...
                          <Col sm={8} className="mb-3 mb-lg-0">
                            <Form.Control
                              type="text"
                              placeholder="Please Enter Fee Head Description"
                              id="headDescription"
                        ...
                        <Row className="mb-3">
                          ...
                          <Col sm={8} className="mb-3 mb-lg-0">
                            <Form.Control
                              type="text"
                              placeholder="Please Enter Fee Head Short Name"
                              id="shortName"
                        ...
                        <Row className="mb-3">
                          <Form.Check.Label className="col-sm-4 col-form-label form-label">
                            Other Fee Head
                          </Form.Check.Label>
                          <Col md={8} xs={12}>
                            <Form.Check
                        ...
                        <Row className="mb-3">
                          <Form.Check.Label className="col-sm-4 col-form-label form-label">
                            Installment Fee Head
                          </Form.Check.Label>
                          <Col md={8} xs={12}>
                            <Form.Check
                              className=" col-form-label form-label"
                              type="checkbox"
                              id="installmentFeeHead"
                              value={formData.installmentFeeHead}
                              onChange={handleInputChange}
                            >
                              <Form.Check.Input
                                type="checkbox"
