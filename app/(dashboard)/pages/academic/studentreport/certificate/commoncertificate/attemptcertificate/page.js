...
import ExternalStudentAttempt from "./external";
import RegularStudentAttempt from "./regular";

const AttemptCertificate = () => {
              ...
              <div>
                {hasMounted && (
                  <>
                    ...
                    {selectedOption === "regular" && <RegularStudentAttempt />}
                    {selectedOption === "external" && <ExternalStudentAttempt />}
                  </>
                )}
              </div>
            </Card.Body>
