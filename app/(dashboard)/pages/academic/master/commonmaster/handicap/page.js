        ...
        <Container fluid className="p-6">
                            ...
                            <div>
                                {hasMounted &&
                                    ...
                                    >
                                        ...
                                        <Row className="mb-3">
                                            <Form.Label className="col-sm-3 col-form-label form-label" htmlFor="fullName">Description<span className="text-danger">*</span></Form.Label>
                                            <Col sm={9} className="mb-3 mb-lg-0">
                                        ...
                                        <Row className="mb-3">
                                            <Form.Label className="col-sm-3 col-form-label form-label" htmlFor="fullName">Percentage</Form.Label>
                                            <Col sm={9} className="mb-3 mb-lg-0">
            ...
            <>
                ...
                <Pagination className="justify-content-end">
                    ...
                    {[...Array(Math.ceil(handicapData.length / itemsPerPage))].map((_, index) => (
                        <Pagination.Item key={index} active={index + 1 === currentPage} onClick={() => paginate(index + 1)}>
                            {index + 1}
                        </Pagination.Item>
                    ))}
                    <Pagination.Next onClick={() => paginate(currentPage + 1)} disabled={currentPage === Math.ceil(handicapData.length / itemsPerPage)} />
                </Pagination>
