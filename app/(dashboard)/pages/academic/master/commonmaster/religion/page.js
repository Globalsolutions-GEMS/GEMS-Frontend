                                    ...
                                    <Form>
                                        <Row className="mb-3">
                                            ...
                                            <Col sm={9} className="mb-3 mb-lg-0">
                                                <Form.Control type="text" placeholder="Please Enter Relegion" id="religion" required />
                                            </Col>
                                        </Row>
                                        ...
                                        <Row className='mb-3'>
                                            ...
                                            <Col md={9} xs={12}>
                                                <Form.Check className="col-sm-3 col-form-label form-label" type="checkbox" id="minority">
                                                    <Form.Check.Input type="checkbox" />
