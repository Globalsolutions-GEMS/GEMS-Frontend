        ...
        <Container fluid className="p-6">
                                    ...
                                    >
                                        <Row className="mb-3">
                                            ...
                                            <Col sm={9} className="mb-3 mb-lg-0">
                                                <Form.Control type="text" placeholder="Please Enter Title" id="nametitle" value={formData.nametitle} onChange={handleInputChange} required />
                                            </Col>
                                        </Row>
            ...
            <>
                ...
                <Pagination className="justify-content-end">
                    ...
                    {[...Array(Math.ceil(nametitleData.length / itemsPerPage))].map((_, index) => (
                        <Pagination.Item key={index} active={index + 1 === currentPage} onClick={() => paginate(index + 1)}>
                            {index + 1}
                        </Pagination.Item>
                    ))}
                    <Pagination.Next onClick={() => paginate(currentPage + 1)} disabled={currentPage === Math.ceil(nametitleData.length / itemsPerPage)} />
                </Pagination>
