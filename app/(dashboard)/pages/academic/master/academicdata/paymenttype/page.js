        ...
        <Container fluid className="p-6">
                            ...
                            <div>
                                {hasMounted &&
                                    <Form onSubmit={handleSubmit}>
                                        <Row className="mb-3">
                                            <Form.Label className="col-sm-3 col-form-label form-label">Payment Type</Form.Label>
                                            <Col sm={9} className="mb-3 mb-lg-0">
                                                <Form.Control type="text" placeholder="Please Enter Payment Type" id="paymentType" value={formData.paymentType} onChange={handleInputChange} required />
                                            </Col>
                                        </Row>
                                        <Row className="mb-3">
                                            <Form.Label className="col-sm-3 col-form-label form-label" >Description</Form.Label>
                                            <Col md={9} xs={12}>
                                        ...
                                        <Row className='mb-3'>
                                            ...
                                            <Col md={9} xs={12}>
                                                <Form.Check className="col-sm-3 col-form-label form-label" type="checkbox" id="checkIfRte" value={formData.checkIfRte} onChange={handleInputChange}>
                                                    <Form.Check.Input type="checkbox" value={formData.checkIfActive} onChange={handleInputChange} />
            ...
            <>
                ...
                <Pagination className="justify-content-end">
                    ...
                    {[...Array(Math.ceil(paymentData.length / itemsPerPage))].map((_, index) => (
