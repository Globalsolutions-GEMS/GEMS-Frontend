...
const FeeHeadWiseChangeOtherFeesBulk = () => {
  const hasMounted = useMounted();

  return (
    <Container fluid className="p-6">
      {/* Page Heading */}
      <PageHeading heading="Fee Head Wise Change Other Fees - Bulk" />
      <Breadcrumb>
        <Breadcrumb.Item href="#">Academic</Breadcrumb.Item>
        <Breadcrumb.Item href="#">Transaction</Breadcrumb.Item>
        <Breadcrumb.Item href="#">Other Fees</Breadcrumb.Item>
        <Breadcrumb.Item active>
        Fee Head Wise Change Other Fees - Bulk
        </Breadcrumb.Item>
      </Breadcrumb>
      <Row className="mb-8">
...
export default FeeHeadWiseChangeOtherFeesBulk;
