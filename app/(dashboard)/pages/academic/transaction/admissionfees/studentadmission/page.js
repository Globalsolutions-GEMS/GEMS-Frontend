  ...
  useEffect(() => {
    ...
    if (hasMounted) {
      getCasteCategory()
        ...
        .catch((error) =>
          console.error("Error fetching CasteCategory:", error)
        );
    }
  }, [hasMounted]);
        ...
        <Card>
          <Card.Body>
            <Col xl={12} lg={8} md={12} xs={12}>
              Note :{" "}
              <span className="text-danger">* Marked Is Mandatory !</span>
                    ...
                    <Card className="mb-3">
                      <Card.Body>
                        ...
                        <Row className="mb-3">
                          ...
                          <Form.Label className="col-sm-2 col-form-label form-label">
                            Standard Fee<span className="text-danger">*</span>
                          </Form.Label>
                          <Col sm={4} className="mb-3 mb-lg-0">
                            <Form.Control
                              type="text"
                      ...
                      <Card.Body>
                        ...
                        <Row className="mb-3">
                          ...
                          <Col sm={4} className="mb-3 mb-lg-0">
                            <Form.Control
                              type="text"
                              placeholder="Please Enter Unicode Father Name"
                              id="ufn"
                              value={formData.ufn}
                              onChange={handleInputChange}
                            />
                        ...
                        <Row className="mb-3">
                          ...
                          <Col sm={4} className="mb-3 mb-lg-0">
                            ...
                            >
                              <option value="" disabled>
                                Please Select a Caste Category
                              </option>
                              {casteCategory.map((castecate) => (
                                <option key={castecate.id} value={castecate.id}>
                                  {castecate.casteCategory}
                                </option>
                              ))}
                            </Form.Select>
                          </Col>
