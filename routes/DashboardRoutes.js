				...
				children: [
					{
						...
						children: [
							...
							{ id: uuid(), link: '/pages/academic/preadmission/fees/basiccourse', name: 'Scholarship Entry' },
							{ id: uuid(), link: '/pages/academic/preadmission/fees/basiccourse', name: 'Demand Updation' },
							{ id: uuid(), link: '/pages/academic/preadmission/fees/basiccourse', name: 'Bulk Other Fees Demand' },
						]
					},
					{
						id: uuid(),
						...
						title: 'Other Fees',
						children: [
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Other Fees' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'General Fine Collection' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Other Fees Demand Updation' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Student Other Demand Cancel' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'FeeHead Wise Bulk Other Demand Updation' },
						]
					},
					{
						id: uuid(),
						...
						title: 'Receipts',
						children: [
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Admission Cancellation' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Cancel Year End Student' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Receipt Cancellation And Reprint' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Admin Receipt Cancellation And Reprint' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Course Change' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Fee Type Change' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Online Payment Requery' },
					...
					},
					{
						...
						title: 'Data Entry',
						children: [
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Student Information' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Student Subject Updation' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Roll No Updation' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Subject Groupwise Roll No' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Subject Groupwise Section' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Section Allocation(YE/PROADM)' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Bulk Updation' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Selected Field Report' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Student Document Receipt' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Outstanding Fees Remiander' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Scholarship Entry' },
							{ id: uuid(), link: '/pages/academic/preadmission/otherfeesdefination/generalfine', name: 'Bulk Email' },
